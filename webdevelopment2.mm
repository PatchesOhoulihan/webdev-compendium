...
<node TEXT="web development" ID="ID_1723255651" CREATED="1283093380553" MODIFIED="1516056879450"><hook NAME="MapStyle">
...
<node TEXT="no script tag" ID="ID_121909318" CREATED="1515602570705" MODIFIED="1515602584248">
...
<node TEXT="Differences Between HTML 4.01 and HTML5" ID="ID_451599228" CREATED="1515602673887" MODIFIED="1515602676907">
...
<node TEXT="Dom Api" ID="ID_1338289551" CREATED="1515591316434" MODIFIED="1515661309146">
...
<node TEXT="cookie" ID="ID_52380751" CREATED="1515591346369" MODIFIED="1515591353168">
<node TEXT="show all cookies" ID="ID_126151023" CREATED="1515591363104" MODIFIED="1515591371563">
...
<node TEXT="Basic concepts" ID="ID_1652000095" CREATED="1515661632023" MODIFIED="1515662961836">
...
<arrowlink SHAPE="CUBIC_CURVE" COLOR="#000000" WIDTH="2" TRANSPARENCY="80" FONT_SIZE="9" FONT_FAMILY="SansSerif" DESTINATION="ID_1898386258" STARTINCLINATION="0;0;" ENDINCLINATION="0;0;" STARTARROW="NONE" ENDARROW="DEFAULT"/>
</node>
...
<node TEXT="Local Storage vs Session Storage vs Cookie" ID="ID_667026147" CREATED="1515662620682" MODIFIED="1515662919772">
<node TEXT="LocalStorage" ID="ID_1260766077" CREATED="1515662635522" MODIFIED="1515662904845">
...
<node TEXT="SessionStorage" ID="ID_1847879931" CREATED="1515662642449" MODIFIED="1515662906918">
...
<node TEXT="Cookie" ID="ID_153902170" CREATED="1515662648522" MODIFIED="1515662909709">
...
<node TEXT="cookies" ID="ID_194660626" CREATED="1515602020518" MODIFIED="1515602026494">
<node TEXT="Was sind Third Party Cookies?" ID="ID_657863754" CREATED="1515602043953" MODIFIED="1515663572516">
...
<node TEXT="Unterschied zu First Party Cookies" ID="ID_1007566117" CREATED="1515602082658" MODIFIED="1515663574972">
...
<node TEXT="Async/await 101" ID="ID_75875922" CREATED="1515703444845" MODIFIED="1515703444845">
...
<node TEXT="Quick Setup" ID="ID_1044908776" CREATED="1515277487524" MODIFIED="1515323490525">
<node TEXT="1. Create an HTML file" ID="ID_409408142" CREATED="1515277527954" MODIFIED="1515277527954"/>
<node TEXT="2. Add scripts to include react.js, react-dom.js and babel.js inside the head of the HTML file" ID="ID_374162392" CREATED="1515277539612" MODIFIED="1515323485901">
...
<node TEXT="3. Add a babel script within the body of the HTML file" ID="ID_268667696" CREATED="1515277602051" MODIFIED="1515323487709">
...
<node TEXT="5. Start rendering elements using ReactJS" ID="ID_52730336" CREATED="1515277713795" MODIFIED="1515323483347">
...
<node TEXT="What is React?" ID="ID_33879117" CREATED="1515278490837" MODIFIED="1515329960900">
<node TEXT="What is ReactJS?" ID="ID_1971369396" CREATED="1515278524808" MODIFIED="1515323933705">
...
<node TEXT="Why should I use ReactJS?" ID="ID_775431334" CREATED="1515278620434" MODIFIED="1515324016705">
...
<node TEXT="What makes ReactJS so efficient at rerendering?" ID="ID_541594190" CREATED="1515278935116" MODIFIED="1515324015040">
...
<node TEXT="Rendering Elements/React Nodes" ID="ID_1168277326" CREATED="1515279503033" MODIFIED="1515425879647">
<node TEXT="React Elements/ React Nodes" ID="ID_730934704" CREATED="1515279516927" MODIFIED="1515426330695">
...
<node TEXT="Creating React Nodes" ID="ID_237369376" CREATED="1515426352525" MODIFIED="1515426377605">
...
<node TEXT="The React.createElement() arguments explained" ID="ID_86733993" CREATED="1515426649144" MODIFIED="1515426808788">
...
<node TEXT="ReactDOM.render()" ID="ID_1736704544" CREATED="1515279598314" MODIFIED="1515574518520">
...
<node TEXT="ReactDOM.render(" ID="ID_1674394648" CREATED="1515279739348" MODIFIED="1515323837002">
...
<node TEXT="ReactDOM.hydrate(element, container[, callback])" ID="ID_565354937" CREATED="1515574601384" MODIFIED="1515574638653">
...
<node TEXT="Rerendering the DOM using additional render() calls" ID="ID_1096528987" CREATED="1515279779165" MODIFIED="1515324110192">
...
<node TEXT="function updateNum(){" ID="ID_688661854" CREATED="1515279916735" MODIFIED="1515323843874">
<node TEXT="ReactDOM.render(" ID="ID_805229431" CREATED="1515279916735" MODIFIED="1515323842938">
...
<node TEXT="JSX" ID="ID_1010983589" CREATED="1515282261275" MODIFIED="1515324114867">
<node TEXT="What is JSX?" ID="ID_223965834" CREATED="1515282290585" MODIFIED="1515329962957">
...
<node TEXT="Using JSX with JavaScript Expressions" ID="ID_688109259" CREATED="1515282432125" MODIFIED="1515324194368">
...
<node TEXT="Using JSX with Attributes" ID="ID_1997338908" CREATED="1515282811921" MODIFIED="1515324311151">
...
<node TEXT="Using JSX with Empty Tags" ID="ID_474530578" CREATED="1515283022704" MODIFIED="1515323861706">
...
<node TEXT="Using JSX with a Style Object" ID="ID_1787823061" CREATED="1515283038318" MODIFIED="1515324323543">
...
<node TEXT="var styleObject = {" ID="ID_640742949" CREATED="1515283291988" MODIFIED="1515323863234">
...
<node TEXT="Using JSX with Nested Elements" ID="ID_868566031" CREATED="1515283421602" MODIFIED="1515327825780">
...
<node TEXT="var element = (" ID="ID_1435809884" CREATED="1515283476897" MODIFIED="1515323868730">
<node TEXT="&lt;div&gt;" ID="ID_1516225385" CREATED="1515283476897" MODIFIED="1515323867746">
...
<node TEXT="var element = (" ID="ID_997006714" CREATED="1515283516215" MODIFIED="1515323871034">
...
<node TEXT="Using JSX Objects" ID="ID_588554578" CREATED="1515283565806" MODIFIED="1515327826860">
...
<node TEXT="if(product.stock &lt; 0){" ID="ID_1819506184" CREATED="1515283616427" MODIFIED="1515323874514">
...
<node TEXT="else{" ID="ID_291111979" CREATED="1515283616428" MODIFIED="1515323875954">
...
<node TEXT="ReactDOM.render(" ID="ID_1217827989" CREATED="1515283629537" MODIFIED="1515323877250">
...
<node TEXT="React Components" ID="ID_1825956271" CREATED="1515324637018" MODIFIED="1515324690463">
...
<node TEXT="Functional Components" ID="ID_122537557" CREATED="1515324693268" MODIFIED="1515327712565">
...
<node TEXT="Here is an example:" ID="ID_1901128368" CREATED="1515324865072" MODIFIED="1515325177129">
<node TEXT="function HelloWorld(){" ID="ID_1458361580" CREATED="1515324876845" MODIFIED="1515325161704">
...
<node TEXT="ReactDOM.render(" ID="ID_326358841" CREATED="1515324972689" MODIFIED="1515327562294">
...
<node TEXT="Adding Properties to Functional Components" ID="ID_729140082" CREATED="1515325035933" MODIFIED="1515327275689">
...
<node TEXT="function HelloWorld(props){" ID="ID_711678944" CREATED="1515325270224" MODIFIED="1515325270224">
...
<node TEXT="ReactDOM.render(" ID="ID_1872941092" CREATED="1515325325331" MODIFIED="1515325325331">
...
<node TEXT="function HelloWorld(props){" ID="ID_1771437225" CREATED="1515325442715" MODIFIED="1515325442715">
...
<node TEXT="ReactDOM.render(" ID="ID_509103179" CREATED="1515325455377" MODIFIED="1515325455377">
...
<node TEXT="Conditional Rendering" ID="ID_240472902" CREATED="1515332033127" MODIFIED="1515332340962">
...
<node TEXT="function Feature(props){" ID="ID_1846267894" CREATED="1515332111814" MODIFIED="1515332111814">
<node TEXT="if (props.active == true){" ID="ID_15134033" CREATED="1515332111815" MODIFIED="1515332111815">
...
<node TEXT="else{" ID="ID_604436228" CREATED="1515332111817" MODIFIED="1515332111817">
...
<node TEXT="function Feature(props){" ID="ID_1130226012" CREATED="1515332208965" MODIFIED="1515332208965">
<node TEXT="return &lt;h1&gt;This feature is {props.active? &quot;active&quot; : &quot;not active&quot;}&lt;/h1&gt;" ID="ID_362997907" CREATED="1515332208966" MODIFIED="1515332208966">
...
<node TEXT="Preventing Rendering" ID="ID_716750890" CREATED="1515332222490" MODIFIED="1515332222490">
...
<node TEXT="function Feature(props){" ID="ID_525977202" CREATED="1515332264581" MODIFIED="1515332264581">
<node TEXT="if(props.active!){" ID="ID_1009197360" CREATED="1515332264582" MODIFIED="1515332264582">
...
<node TEXT="else{" ID="ID_1718772304" CREATED="1515332264583" MODIFIED="1515332264583">
...
<node TEXT="function Feature(props){" ID="ID_544492799" CREATED="1515332319665" MODIFIED="1515332319665">
<node TEXT="return (" ID="ID_1964079972" CREATED="1515332319665" MODIFIED="1515332319665">
...
<node TEXT="React Component State" ID="ID_782203120" CREATED="1515493940300" MODIFIED="1515493940300">
...
<node TEXT="Things to keep in mind about React component state:" ID="ID_637926048" CREATED="1515494272468" MODIFIED="1515494272468">
...
<node TEXT="Html" POSITION="left" ID="ID_29829950" CREATED="1515277277215" MODIFIED="1516057186174" HGAP="-130" VSHIFT="-130">
<edge COLOR="#0000ff"/>
</node>
...
<node TEXT="ide" POSITION="left" ID="ID_228200571" CREATED="1515574322932" MODIFIED="1516057170754">
<edge COLOR="#ffff00"/>
...
<node TEXT="phpstorm" ID="ID_965972960" CREATED="1515574343157" MODIFIED="1515574352085">
<node TEXT="go to definition" ID="ID_1095348031" CREATED="1515574359237" MODIFIED="1515574366067">
<node TEXT="strg" ID="ID_1676912443" CREATED="1515574369460" MODIFIED="1515574372945"/>
</node>
<node TEXT="search in for filesnames" ID="ID_1423732730" CREATED="1515574375974" MODIFIED="1515574391971">
<node TEXT="shift x 2" ID="ID_665947203" CREATED="1515574397046" MODIFIED="1515574409971"/>
</node>
</node>
</node>
<node TEXT="Chrome dev tools" POSITION="left" ID="ID_395427149" CREATED="1515600554268" MODIFIED="1516057170758">
<edge COLOR="#7c0000"/>
